...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 811.0, 187.0, 50.0, 35.0 ],
					"style" : "",
					"text" : "d859333"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 381.0, 247.0, 56.0, 22.0 ],
									"style" : "",
									"text" : "deferlow"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 470.0, 325.006714, 30.0, 30.0 ],
									"style" : ""
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "bang" ],
									"patching_rect" : [ 359.0, 196.006714, 130.0, 22.0 ],
									"style" : "",
									"text" : "t l bang"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 4,
									"outlettype" : [ "", "", "", "" ],
									"patching_rect" : [ 258.0, 147.006714, 120.0, 22.0 ],
									"style" : "",
									"text" : "route start stop clear"
								}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"style" : "",
									"text" : "script connect dNext 0 d859333 0"
								}
...
, 							{
								"box" : 								{
									...
									"style" : "",
									"text" : "script connect d859333 3 dOut123 2"
								}
...
, 							{
								"box" : 								{
									...
									"style" : "",
									"text" : "script connect d859333 2 dOut123 1"
								}
...
, 							{
								"box" : 								{
									...
									"style" : "",
									"text" : "script connect d859333 1 dOut123 0"
								}
...
, 							{
								"box" : 								{
									...
									"style" : "",
									"text" : "script connect d859333 0 dOut0 0"
								}
...
, 							{
								"box" : 								{
									...
									"style" : "",
									"text" : "script connect routing 0 d859333 0"
								}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 53.0, 401.0, 107.0, 21.0 ],
					"style" : "",
					"text" : "gate"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 141.0, 367.0, 36.0, 21.0 ],
					"style" : "",
					"text" : "del 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "int" ],
					"patching_rect" : [ 141.0, 333.0, 39.0, 21.0 ],
					"style" : "",
					"text" : "t b i",
					"varname" : "dOut0"
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 62.5, 433.0, 39.0, 433.0, 39.0, 253.0, 111.5, 253.0 ],
					"source" : [ "obj-18", 0 ]
				}
