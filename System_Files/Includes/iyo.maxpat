...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 148.0, 133.0, 96.0, 22.0 ],
									"style" : "",
									"text" : "prepend symbol"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "int" ],
									"patching_rect" : [ 59.5, 100.0, 65.0, 22.0 ],
									"style" : "",
									"text" : "unpack s i"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 148.0, 215.0, 30.0, 30.0 ],
									"style" : ""
								}
...
,
					"patching_rect" : [ 257.0, 123.0, 73.0, 22.0 ],
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 277.0, 190.0, 50.0, 35.0 ],
									"style" : "",
									"text" : "symbol 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 136.0, 24.0, 29.5, 22.0 ],
									"style" : "",
									"text" : "Z 1"
								}
...
,
					"patching_rect" : [ 101.0, 184.0, 73.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
,
					"patching_rect" : [ 67.0, 123.0, 79.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 18.0, 76.0, 20.0, 20.0 ],
					"style" : ""
				}
...
,
					"patching_rect" : [ 383.0, 130.0, 87.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 383.0, 92.0, 24.0, 24.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 18.0, 148.0, 20.0, 20.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 491.0, 61.0, 54.0, 22.0 ],
					"style" : "",
					"text" : "route i o"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "int" ],
					"patching_rect" : [ 358.0, 212.0, 32.5, 22.0 ],
					"style" : "",
					"text" : "t b i"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 328.75, 174.0, 62.25, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 80.0, 148.0, 33.0, 20.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 257.0, 174.0, 65.75, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 35.0, 148.0, 45.0, 20.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 106.0, 363.0, 25.0, 25.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "int" ],
					"patching_rect" : [ 162.75, 284.0, 32.5, 22.0 ],
					"style" : "",
					"text" : "t b i"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 106.0, 336.0, 80.0, 22.0 ],
					"style" : "",
					"text" : "sprintf %s%s"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 162.75, 238.0, 51.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 89.75, 76.0, 46.0, 20.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 97.0, 238.0, 60.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 35.0, 76.0, 56.0, 20.0 ],
					"style" : "",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
