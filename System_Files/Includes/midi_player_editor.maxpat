...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 811.0, 187.0, 50.0, 22.0 ],
					"style" : "",
					"text" : "d10250"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"style" : "",
									"text" : "script connect dNext 0 d10250 0"
								}
...
, 							{
								"box" : 								{
									...
									"style" : "",
									"text" : "script connect d10250 3 dOut123 2"
								}
...
, 							{
								"box" : 								{
									...
									"style" : "",
									"text" : "script connect d10250 2 dOut123 1"
								}
...
, 							{
								"box" : 								{
									...
									"style" : "",
									"text" : "script connect d10250 1 dOut123 0"
								}
...
, 							{
								"box" : 								{
									...
									"style" : "",
									"text" : "script connect d10250 0 dOut0 0"
								}
...
, 							{
								"box" : 								{
									...
									"style" : "",
									"text" : "script connect routing 0 d10250 0"
								}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 527.0, 331.0, 413.0, 35.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 102.0, 258.0, 31.0, 21.0 ],
					"style" : "",
					"text" : "next",
					"varname" : "dNext"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 48.0, 454.0, 107.0, 21.0 ],
					"style" : "",
					"text" : "gate"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 241.0, 343.0, 115.0, 21.0 ],
					"style" : "",
					"text" : "makenote",
					"varname" : "dOut123"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 136.0, 420.0, 64.0, 21.0 ],
					"style" : "",
					"text" : "del 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "int" ],
					"patching_rect" : [ 136.0, 343.0, 59.0, 21.0 ],
					"style" : "",
					"text" : "t b i",
					"varname" : "dOut0"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 201.0, 217.0, 99.5, 22.0 ],
					"save" : [ "#N", "detonate", "d10250", ";", "#X", "setparam", 0, "Time", 0, 0, 999999, 0, 1000, 200, 0, ";", "#X", "setparam", 1, "Pitch", 0, 0, 127, 60, 12, 4, 0, ";", "#X", "setparam", 2, "Vel", 0, 0, 127, 64, 12, 4, 0, ";", "#X", "setparam", 3, "Dur", 0, 1, 99999, 200, 800, 200, 0, ";", "#X", "setparam", 4, "Chan", 0, 1, 16, 1, 8, 1, 0, ";", "#X", "setparam", 5, "Track", 0, 1, 32, 1, 8, 1, 0, ";", "#X", "setparam", 6, "X1", 0, 0, 999, 0, 80, 20, 0, ";", "#X", "setparam", 7, "X2", 0, 0, 999, 0, 80, 20, 0, ";", "#X", "restore", ";", "#X", "stop", ";" ],
					"style" : "",
					"text" : "detonate d10250",
					"varname" : "d10250"
				}
