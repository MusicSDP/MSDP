...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 950.5, 514.5, 61.0, 22.0 ],
					"style" : "",
					"text" : "1280 800"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 896.5, 550.0, 81.0, 22.0 ],
					"style" : "",
					"text" : "s dim2render"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 881.0, 481.5, 264.0, 22.0 ],
					"style" : "",
					"text" : "read vs_patchbook_radial_displacement.json, 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 881.0, 452.5, 60.0, 22.0 ],
					"style" : "",
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 129.5, 186.0, 126.0, 64.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 395.5, 39.0, 301.0, 86.0 ],
					"varname" : "vs_wfg_2[2]",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture", "jit_gl_texture" ],
					"patching_rect" : [ 549.166626, 238.5, 301.0, 86.0 ],
					"varname" : "vs_wfg_2[1]",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture" ],
					"patching_rect" : [ 507.5, 343.5, 144.0, 105.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 793.0, 481.5, 79.0, 22.0 ],
					"style" : "",
					"text" : "clientwindow"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 711.0, 516.0, 161.0, 64.0 ],
					"pattrstorage" : "vsynth",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 750.0, 481.5, 36.0, 22.0 ],
					"style" : "",
					"text" : "write"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 711.0, 481.5, 35.0, 22.0 ],
					"style" : "",
					"text" : "read"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 711.0, 516.0, 120.0, 35.0 ],
					"saved_object_attributes" : 					{
						"client_rect" : [ 510, 64, 975, 616 ],
						"parameter_enable" : 0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 711.0, 522.5, 120.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 232.5, 539.5, 112.0, 16.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture", "jit_gl_texture" ],
					"patching_rect" : [ 129.5, 36.5, 235.0, 91.0 ],
					"varname" : "vs_wfg_rad",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture" ],
					"patching_rect" : [ 232.5, 291.0, 197.0, 146.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture", "jit_gl_texture" ],
					"patching_rect" : [ 507.5, 140.0, 301.0, 86.0 ],
					"varname" : "vs_wfg_2",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture" ],
					"patching_rect" : [ 31.0, 36.0, 92.0, 88.0 ],
					"varname" : "vs_preview",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture" ],
					"patching_rect" : [ 232.5, 465.0, 50.0, 60.0 ],
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-3", 1 ],
					"midpoints" : [ 242.0, 450.0, 116.0, 450.0, 116.0, 160.0, 192.5, 160.0 ],
					"order" : 0,
					"source" : [ "obj-17", 0 ]
				}
...
, 			{
		...
		"parameters" : 		{
			"obj-17::obj-77::obj-32" : [ "displacement_x_mod_range", "scale_freq_x", 0 ],
			...
			"obj-17::obj-77::obj-47" : [ "displacement_angle_m", "ROT_M", 0 ],
			...
			"obj-17::obj-77::obj-44" : [ "displacement_zoom_m", "ZOOM_M", 0 ],
			"obj-17::obj-77::obj-31" : [ "displacement_y_mod_range", "scale_freq_y", 0 ],
			...
			"obj-20::obj-12" : [ "wfg2_sync_dir", "sync_invert", 0 ],
			...
			"obj-3::obj-19" : [ "luma_invert[1]", "invert", 0 ],
			...
			"obj-23::obj-12" : [ "wfg2_sync_dir[2]", "sync_invert", 0 ],
			...
			"obj-17::obj-77::obj-6" : [ "displacement_x", "X", 0 ],
