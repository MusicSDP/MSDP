...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 368.0, 94.0, 63.0, 22.0 ],
					"style" : "",
					"text" : "enable $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 330.0, 4.5, 30.0, 30.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 379.0, 56.0, 77.0, 22.0 ],
					"style" : "",
					"text" : "route enable"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 234.0, 165.0, 106.0, 22.0 ],
					"style" : "",
					"text" : "enable_mouse $1"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 80.0, 0.0, 15.0, 15.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 508.0, 164.0, 116.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 295.0, 114.0, 24.0, 24.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					"bgcolor" : [ 0.65098, 0.65098, 0.65098, 1.0 ],
					"blinkcolor" : [ 0.862745, 0.870588, 0.878431, 0.98 ],
					"id" : "obj-6",
					"maxclass" : "button",
					"numinlets" : 1,
					"numoutlets" : 1,
					...
					"patching_rect" : [ 453.5, 124.0, 24.0, 24.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 95.0, 0.0, 15.0, 15.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 453.5, 165.0, 37.0, 22.0 ],
					"style" : "",
					"text" : "reset"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 56.0, 12.0, 64.0, 15.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 1.0, 0.0, 64.0, 15.0 ],
					"style" : "",
					"text" : "CORNERPINS"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 349.0, 165.0, 93.0, 22.0 ],
					"style" : "",
					"text" : "drawcorners $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 11.0, 274.0, 433.0, 22.0 ],
					"style" : "",
					"text" : "jit.gl.cornerpin vsynth @drawcorners 0 @enable_mouse 0 @preserve_aspect 1"
				}
