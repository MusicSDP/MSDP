...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 186.0, 129.0, 150.0, 64.0 ],
					"presentation" : 1,
					"presentation_linecount" : 4,
					"presentation_rect" : [ 140.0, 114.5, 100.0, 64.0 ],
					"text" : "1. Freq\n2. FM Amount\n3. PM Amount\n4. PWM Amount"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 684.0, 132.0, 51.0, 23.0 ],
					"text" : "pwm $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 526.0, 139.0, 42.0, 23.0 ],
					"text" : "pm $1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 197.1053466796875, 100.0, 50.0, 23.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 197.1053466796875, 132.0, 40.0, 23.0 ],
					"text" : "fm $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 197.1053466796875, 73.0, 121.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 39.105354309082031, 87.0, 50.0, 23.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 39.105354309082031, 119.0, 47.0, 23.0 ],
					"text" : "freq $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 39.105354309082031, 60.0, 121.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 285.0, 47.0, 150.0, 21.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 91.75, 170.5, 55.0, 21.0 ],
					"text" : "7. PWM"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 270.0, 32.0, 150.0, 21.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 91.75, 141.5, 45.0, 21.0 ],
					"text" : "6. PM"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 211.14300537109375, 226.0, 301.0, 86.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 684.0, 99.0, 50.0, 23.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 683.5, 58.0, 124.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 526.0, 104.0, 50.0, 23.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 525.5, 63.0, 124.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 91.75, 198.0, 66.0, 21.0 ],
					"text" : "8. Output"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 255.0, 17.0, 150.0, 21.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 91.75, 112.5, 45.0, 21.0 ],
					"text" : "5. FM"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 811.0, 47.0, 128.0, 128.0 ],
					"presentation" : 1,
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 206.6053466796875, 125.0, 187.709716796875, 125.0, 187.709716796875, 58.0, 206.6053466796875, 58.0 ],
					"order" : 0,
					"source" : [ "obj-24", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 48.605354309082031, 112.0, 29.709724426269531, 112.0, 29.709724426269531, 45.0, 48.605354309082031, 45.0 ],
					"order" : 0,
					"source" : [ "obj-29", 0 ]
				}
