...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 503.0, 338.5, 150.0, 50.0 ],
					"text" : "Using the Vizzie version of jit.luma to take advantage of textures over matrices"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 510.1666259765625, 286.0, 90.0, 23.0 ],
					"text" : "prepend param"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 605.0, 286.0, 90.0, 23.0 ],
					"text" : "prepend param"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 701.0, 286.0, 90.0, 23.0 ],
					"text" : "prepend param"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 510.1666259765625, 240.0, 51.0, 23.0 ],
					"text" : "luma $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 229.1666259765625, 308.0, 73.0, 23.0 ],
					"text" : "vzgl-routegl"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 223.5, 236.0, 266.5, 23.0 ],
					"text" : "2input-router"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 229.0, 418.0, 20.0, 23.0 ],
					"text" : "t l"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 229.1666259765625, 345.0, 260.8333740234375, 37.0 ],
					"text" : "jit.gl.slab @file co.lumakey.jxs @param binary 1 @param fade 0.05 @param tol 0.05"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 306.0, 308.0, 67.0, 23.0 ],
					"text" : "vzgl-object"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 701.0, 240.0, 51.0, 23.0 ],
					"text" : "fade $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 605.0, 240.0, 62.0, 23.0 ],
					"text" : "tol $1"
				}
...
, 			{
				"box" : 				{
					"args" : [ "p7", "7. Fade", 0.0, 1.0, 0.5, "f", 3 ],
					"bgmode" : 0,
					"border" : 0,
					"clickthrough" : 0,
					"enablehscroll" : 0,
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 701.0, 143.704345703125, 55.0, 85.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 170.0, 134.433029174804688, 55.0, 85.0 ],
					"varname" : "p7",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 605.0, 143.704345703125, 55.0, 85.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 108.0, 134.433029174804688, 55.0, 85.0 ],
					"varname" : "p6",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 303.5, 189.488037109375, 71.0, 27.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 143.5, 91.433029174804688, 71.0, 27.0 ],
					"varname" : "p2",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 303.5, 161.488037109375, 71.0, 21.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 139.5, 68.433029174804688, 71.0, 21.0 ],
					"text" : "2. Source 2"
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 153.14300537109375, 465.863037109375, 71.0, 27.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 229.0, 473.0, 108.0, 138.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 76.14300537109375, 465.863037109375, 71.0, 27.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 223.5, 189.488037109375, 71.0, 27.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 62.0, 91.433029174804688, 71.0, 27.0 ],
					"varname" : "p1",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ -6.85699462890625, 473.0, 71.0, 21.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 223.5, 161.488037109375, 71.0, 21.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 62.0, 68.433029174804688, 71.0, 21.0 ],
					"text" : "1. Source 1"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 95.5, 5.0, 210.5, 29.0 ],
					"varname" : "pSave",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 510.1666259765625, 143.704345703125, 55.0, 85.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 51.0, 134.433029174804688, 55.0, 85.0 ],
					"varname" : "p5",
					"viewvisibility" : 1
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 238.6666259765625, 400.750000234374966, 238.5, 400.750000234374966 ],
					"source" : [ "obj-35", 0 ]
				}
...
, 			{
		...
		"parameters" : 		{
			"obj-6::obj-15" : [ "live.dial[1]", "live.dial", 0 ],
			"obj-170::obj-15" : [ "live.dial", "live.dial", 0 ],
			"obj-10::obj-15" : [ "live.dial[3]", "live.dial", 0 ],
			"parameterbanks" : 			{
