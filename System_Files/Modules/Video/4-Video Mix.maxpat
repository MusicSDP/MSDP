...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 844.14300537109375, 690.0, 150.0, 21.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 163.957809448242188, 114.5, 76.0, 21.0 ],
					"text" : "10/11 Outs"
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 923.14300537109375, 651.0, 71.0, 27.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 171.0, 167.0, 63.0, 27.0 ],
					"varname" : "p11",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 169.0, 63.0, 150.0, 21.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 171.0, 62.5, 61.915611267089844, 21.0 ],
					"text" : "9. Mode"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 724.5, 414.0, 63.25, 21.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 75.0, 131.0, 64.0, 21.0 ],
					"text" : "7. D In"
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 724.5, 437.0, 71.0, 27.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 75.0, 150.0, 64.0, 27.0 ],
					"varname" : "p7",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 639.5, 414.0, 63.25, 21.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 9.0, 131.0, 64.0, 21.0 ],
					"text" : "5. C In"
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 639.5, 437.0, 71.0, 27.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 9.0, 150.0, 64.0, 27.0 ],
					"varname" : "p5",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 560.0, 414.0, 63.25, 21.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 75.0, 2.0, 64.0, 21.0 ],
					"text" : "3. B In"
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 560.0, 437.0, 71.0, 27.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 75.0, 21.0, 64.0, 27.0 ],
					"varname" : "p3",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 924.14300537109375, 495.0, 99.0, 23.0 ],
					"text" : "msdp.param p9 2",
					"varname" : "p9"
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 839.0, 651.0, 71.0, 27.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 171.0, 137.5, 63.0, 27.0 ],
					"varname" : "p10",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 171.0, 204.0, 187.0, 56.0 ],
					"text" : "12. 4-Out Mix Off",
					"textcolor" : [ 0.094117647058824, 0.101960784313725, 0.101960784313725, 1.0 ],
					"texton" : "12. 4-Out Mix On",
...
, 			{
				"box" : 				{
					"args" : [ "p8", "8. D Amt", 0.0, 1.0, 0.33, "f", 2 ],
					"bgmode" : 0,
					"border" : 0,
					"clickthrough" : 0,
					"enablehscroll" : 0,
					...
					"presentation" : 1,
					"presentation_rect" : [ 75.0, 179.0, 61.0, 94.0 ],
					"varname" : "p25",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					"args" : [ "p6", "6. C Amt", 0.0, 1.0, 0.33, "f", 2 ],
					"bgmode" : 0,
					"border" : 0,
					"clickthrough" : 0,
					"enablehscroll" : 0,
					...
					"presentation" : 1,
					"presentation_rect" : [ 9.0, 179.0, 61.0, 94.0 ],
					"varname" : "p6",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					"args" : [ "p4", "4. B Amt", 0.0, 1.0, 0.33, "f", 2 ],
					"bgmode" : 0,
					"border" : 0,
					"clickthrough" : 0,
					"enablehscroll" : 0,
					...
					"presentation" : 1,
					"presentation_rect" : [ 75.0, 50.0, 61.0, 94.0 ],
					"varname" : "p4",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					"args" : [ "p2", "2. A Amt", 0.0, 1.0, 0.33, "f", 2 ],
					"bgmode" : 0,
					"border" : 0,
					"clickthrough" : 0,
					"enablehscroll" : 0,
					...
					"presentation" : 1,
					"presentation_rect" : [ 9.0, 50.0, 54.0, 94.0 ],
					"varname" : "p2",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 924.14300537109375, 576.0, 89.0, 23.0 ],
					"text" : "scale 0 32 0. 1."
				}
...
, 			{
				"box" : 				{
					"activebgcolor" : [ 0.396, 0.875, 0.812, 1.0 ],
					...
					"outlettype" : [ "", "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 924.14300537109375, 536.991455078125, 100.0, 23.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 171.0, 85.5, 61.915611267089844, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 1078.0, 641.5, 108.0, 138.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 263.5, 62.5, 108.0, 138.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 474.0, 437.0, 71.0, 27.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 9.0, 21.0, 64.0, 27.0 ],
					"varname" : "p1",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 474.0, 414.0, 63.25, 21.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 9.0, 2.0, 64.0, 21.0 ],
					"text" : "1. A In"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 147.5, 19.0, 210.5, 29.0 ],
					"varname" : "pSave",
					"viewvisibility" : 1
				}
...
, 			{
		...
		"parameters" : 		{
			"obj-136::obj-14" : [ "umenu[6]", "umenu", 0 ],
			"obj-136::obj-35" : [ "Mix 4", "Mix 4", 0 ],
			"obj-136::obj-29" : [ "pictctrl[8]", "pictctrl[1]", 0 ],
			"obj-136::obj-58" : [ "pictctrl[10]", "pictctrl[1]", 0 ],
			"obj-136::obj-57" : [ "Mix 3", "Mix 3", 0 ],
			"obj-136::obj-36" : [ "Mix 2", "Mix 2", 0 ],
			"obj-137" : [ "umenu[7]", "umenu", 0 ],
			"obj-136::obj-37" : [ "Mix 1", "Mix 1", 0 ],
			"obj-136::obj-22" : [ "pictctrl[7]", "pictctrl[1]", 0 ],
			"obj-136::obj-26" : [ "pictctrl[9]", "pictctrl[1]", 0 ],
			"obj-136::obj-1" : [ "range[3]", "range", 0 ],
			"obj-136::obj-51" : [ "pictctrl[6]", "pictctrl[1]", 0 ],
			"parameterbanks" : 			{
