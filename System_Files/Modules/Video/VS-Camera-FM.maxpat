...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 302.78179931640625, 148.0, 74.0, 21.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 141.25, 191.0, 62.0, 21.0 ],
					"text" : "6. Format",
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 673.5, 471.0, 55.0, 23.0 ],
					"text" : "deferlow"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 734.5, 504.0, 180.0, 23.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 29.75, 190.0, 111.0, 23.0 ]
				}
...
,
					"patching_rect" : [ 734.5, 471.0, 102.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 630.5, 400.0, 150.0, 21.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 673.5, 443.0, 140.0, 23.0 ],
					"text" : "msdp.param.defer p6 foo",
					"varname" : "p6"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 734.5, 535.5694580078125, 61.0, 23.0 ],
					"text" : "format $1"
				}
...
, 			{
				"box" : 				{
					...
					"lockeddragscroll" : 0,
					"maxclass" : "bpatcher",
					"name" : "vs_camera_fm_msdp.maxpat",
					"numinlets" : 3,
					"numoutlets" : 8,
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture", "jit_gl_texture", "int", "", "", "", "", "" ],
					"patching_rect" : [ 214.78179931640625, 180.0, 116.0, 87.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 34.0, 43.5, 116.0, 87.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 222.36932373046875, 480.0, 150.0, 64.0 ],
					"presentation" : 1,
					"presentation_linecount" : 4,
					"presentation_rect" : [ 152.0, 51.0, 90.0, 64.0 ],
					"text" : "1. Cam ID\n2. Cam Toggle\n3. Freq Mod X\n4. Freq Mod Y"
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 575.78179931640625, 653.0, 71.0, 27.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 249.5, 206.0, 71.0, 27.0 ],
					"varname" : "p8",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 432.36932373046875, 358.0, 46.0, 23.0 ],
					"text" : "fmx $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 432.36932373046875, 326.0, 121.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 447.78179931640625, 276.0, 58.0, 23.0 ],
					"text" : "toggle $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 447.78179931640625, 244.0, 121.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 388.14300537109375, 224.0, 35.0, 23.0 ],
					"text" : "id $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 388.14300537109375, 192.0, 121.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 495.0, 387.0, 45.0, 23.0 ],
					"text" : "fmy $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 668.6387939453125, 653.0, 108.0, 138.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 237.0, 22.5, 108.0, 138.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 465.78179931640625, 653.0, 71.0, 27.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 249.5, 161.0, 71.0, 27.0 ],
					"varname" : "p7",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 214.78179931640625, 133.0, 71.0, 27.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 34.0, 157.0, 71.0, 27.0 ],
					"varname" : "p5",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 495.0, 358.0, 124.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 33.369331359863281, 400.0, 150.0, 21.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 249.5, 186.0, 61.25, 21.0 ],
					"text" : "7/8 Outs"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 287.78179931640625, 133.0, 74.0, 21.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 29.75, 132.5, 62.0, 21.0 ],
					"text" : "5. FM In",
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 33.75, 7.5, 157.0, 29.0 ],
					"varname" : "pSave",
					"viewvisibility" : 1
				}
...
, 			{
		...
		"parameters" : 		{
			"obj-5::obj-38" : [ "cam2_on_off[2]", "on_off", 0 ],
			"obj-5::obj-21" : [ "cam2_fm_y[2]", "fmy", 0 ],
			"obj-5::obj-18" : [ "can2_scale_freq_y[2]", "scale_freq_y", 0 ],
			"obj-5::obj-11" : [ "cam2_scale_freq_x[2]", "scale_freq_x", 0 ],
			"obj-5::obj-20" : [ "cam2_fm_x[2]", "fmx", 0 ],
			"parameterbanks" : 			{
