...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 603.0, 793.0, 20.0, 23.0 ],
					"text" : "t l"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 620.0, 554.928955078125, 83.0, 23.0 ],
					"text" : "vzgl-routemat"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 598.0, 751.0, 20.0, 23.0 ],
					"text" : "t l"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 620.0, 751.0, 20.0, 23.0 ],
					"text" : "t l"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 843.0, 751.0, 20.0, 23.0 ],
					"text" : "t l"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 1352.0, 554.928955078125, 145.0, 23.0 ],
					"text" : "substitute tint enable_tint"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1047.0, 554.928955078125, 75.0, 23.0 ],
					"text" : "pak steps f f"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 951.0, 717.0, 62.0, 23.0 ],
					"text" : "zl.change"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 951.0, 686.0, 61.0, 23.0 ],
					"text" : "route dim"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "bang" ],
					"patching_rect" : [ 843.0, 554.928955078125, 169.0, 23.0 ],
					"text" : "t getdim l l b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 620.0, 194.0, 186.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 943.0, 592.0, 67.0, 23.0 ],
					"text" : "vzgl-object"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 843.0, 651.0, 127.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1015.0, 390.5, 126.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 878.0, 390.5, 126.0, 23.0 ],
					"text" : "expr $f1*$f1*$f1*$f1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "int" ],
					"patching_rect" : [ 1095.0, 300.0, 61.0, 23.0 ],
					"text" : "unpack i i"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1015.0, 425.0, 99.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 878.0, 425.0, 99.0, 23.0 ],
					"text" : "scale 0. 1. 1 640"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1685.0, 169.0, 79.0, 23.0 ],
					"text" : "r output_dim"
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 1522.5, 133.4329833984375, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1522.5, 192.746978759765625, 55.0, 23.0 ],
					"text" : "s askme"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 1522.5, 160.739990234375, 60.0, 23.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1015.0, 489.0, 51.0, 22.0 ],
					"text" : "rows $1"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 598.0, 156.0, 85.0, 23.0 ],
					"text" : "video-handler"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 598.0, 83.0, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1352.0, 489.0, 44.0, 22.0 ],
					"text" : "tint $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1180.0, 489.0, 56.0, 22.0 ],
					"text" : "mode $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 878.0, 489.0, 70.0, 22.0 ],
					"text" : "columns $1"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 620.0, 651.0, 192.0, 24.0 ],
					"text" : "jit.eclipse @tint 1 @inv 1@op 0"
				}
...
, 			{
				"box" : 				{
					...
					"hint" : "Sets the application of tinting to the fractalized image",
					...
					"outlettype" : [ "", "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 1352.0, 403.0, 50.0, 15.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_shortname" : "umenu",
							"parameter_enum" : [ "tint off", "tint on" ],
							"parameter_type" : 2,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 729.0, 154.5, 40.0, 20.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 33.0, 102.5, 99.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 33.0, 85.0, 150.0, 21.0 ],
					"text" : "6. Tint Toggle"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 302.0, 169.5, 100.0, 23.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 121.0, 119.0, 129.0, 23.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 408.0, 137.5, 99.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 408.0, 169.5, 114.0, 74.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 121.0, 69.0, 129.0, 29.0 ],
					"text" : "6. Tint Off",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 311.0, 105.0, 150.0, 21.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 121.0, 100.0, 129.0, 21.0 ],
					"text" : "7. Tint Mode",
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 302.0, 130.5, 99.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 33.0, 134.5, 114.0, 74.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 121.0, 146.0, 129.0, 52.0 ],
					"text" : "8. Fractals Bypass",
					"textcolor" : [ 0.094117647058824, 0.101960784313725, 0.101960784313725, 1.0 ],
					"texton" : "8. Fractals On",
					"textoncolor" : [ 0.094117647058824, 0.101960784313725, 0.101960784313725, 1.0 ],
					"truncate" : 0
				}
...
, 			{
				"box" : 				{
					"args" : [ "p4", "4. Hori", 0.0, 1.0, 0.5, "f", 2 ],
					"bgmode" : 0,
					"border" : 0,
					"clickthrough" : 0,
					"enablehscroll" : 0,
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "float" ],
					"patching_rect" : [ 159.3770751953125, 134.5, 55.5, 94.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 4.5, 91.0, 54.0, 94.0 ],
					"varname" : "p4",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 681.43426513671875, 841.0, 71.0, 27.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 171.75, 203.0, 71.0, 27.0 ],
					"varname" : "p3",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					"args" : [ "p5", "5. Vert", 0.0, 1.0, 0.5, "f", 2 ],
					"bgmode" : 0,
					"border" : 0,
					"clickthrough" : 0,
					"enablehscroll" : 0,
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "float" ],
					"patching_rect" : [ 238.3770751953125, 130.5, 55.5, 94.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 60.5, 91.0, 54.0, 94.0 ],
					"varname" : "p5",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 754.43426513671875, 841.0, 108.0, 138.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 253.5, 69.0, 108.0, 138.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 603.0, 841.0, 71.0, 27.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 4.5, 203.0, 71.0, 27.0 ],
					"varname" : "p2",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 264.0, 54.0, 71.0, 27.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 4.5, 40.0, 71.0, 27.0 ],
					"varname" : "p1",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 109.56573486328125, 339.0, 150.0, 21.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 67.5, 203.0, 150.0, 21.0 ],
					"text" : "2/3 Video Outputs"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 264.0, 31.0, 150.0, 21.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 67.5, 43.0, 150.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 37.4375, 15.796875, 62.5625, 17.40625 ],
					"text" : "MIRA OFF",
					"texton" : "MIRA ON",
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 629.5, 415.5, 802.5, 415.5 ],
					"order" : 0,
					"source" : [ "obj-24", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-32", 0 ],
					"midpoints" : [ 1361.5, 642.0, 852.5, 642.0 ],
					"source" : [ "obj-28", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 1146.5, 335.5, 1088.5, 335.5 ],
					"source" : [ "obj-40", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 1104.5, 330.5, 951.5, 330.5 ],
					"source" : [ "obj-40", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-5", 2 ],
					"midpoints" : [ 1024.5, 470.464477999999986, 1112.5, 470.464477999999986 ],
					"order" : 0,
					"source" : [ "obj-42", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-5", 1 ],
					"midpoints" : [ 887.5, 475.464477999999986, 1084.5, 475.464477999999986 ],
					"order" : 0,
					"source" : [ "obj-43", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 1694.5, 297.0, 1104.5, 297.0 ],
					"source" : [ "obj-45", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-32", 0 ],
					"midpoints" : [ 1056.5, 636.464477999999986, 852.5, 636.464477999999986 ],
					"source" : [ "obj-5", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-44", 0 ],
					"midpoints" : [ 1024.5, 519.5, 629.5, 519.5 ],
					"source" : [ "obj-51", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-40", 0 ],
					"midpoints" : [ 960.5, 749.0, 1747.0, 749.0, 1747.0, 291.0, 1104.5, 291.0 ],
					"source" : [ "obj-6", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-44", 0 ],
					"midpoints" : [ 1361.5, 519.5, 629.5, 519.5 ],
					"order" : 1,
					"source" : [ "obj-70", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-32", 0 ],
					"midpoints" : [ 1189.5, 639.0, 852.5, 639.0 ],
					"order" : 0,
					"source" : [ "obj-71", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-44", 0 ],
					"midpoints" : [ 1189.5, 519.5, 629.5, 519.5 ],
					"order" : 1,
					"source" : [ "obj-71", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-44", 0 ],
					"midpoints" : [ 887.5, 519.5, 629.5, 519.5 ],
					"source" : [ "obj-72", 0 ]
				}
...
, 			{
		...
		"parameters" : 		{
			"obj-76" : [ "umenu[5]", "umenu", 0 ],
			"obj-77" : [ "range[2]", "range", 0 ],
			"parameterbanks" : 			{
