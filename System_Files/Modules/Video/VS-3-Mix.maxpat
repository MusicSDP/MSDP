...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"presentation_rect" : [ 162.0, 138.5, 90.0, 64.0 ],
					"text" : "4. In1 Amnt\n5. In2 Amnt\n6. In3 Amnt\n7. Master Amnt",
					"textjustification" : 0
				}
...
, 			{
				"box" : 				{
					...
					"lockeddragscroll" : 0,
					"maxclass" : "bpatcher",
					"name" : "vs_mixer_3_msdp.maxpat",
					"numinlets" : 4,
					"numoutlets" : 5,
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture", "", "", "", "" ],
					"patching_rect" : [ 211.14300537109375, 244.0, 144.0, 105.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 16.0, 95.5, 144.0, 105.0 ],
					"varname" : "vs_mixer_3",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 268.5, 209.0, 71.0, 27.0 ],
					"varname" : "p9",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 432.36932373046875, 358.0, 42.0, 23.0 ],
					"text" : "in3 $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 447.78179931640625, 276.0, 42.0, 23.0 ],
					"text" : "in2 $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 388.14300537109375, 224.0, 42.0, 23.0 ],
					"text" : "in1 $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 457.0, 439.0, 61.0, 23.0 ],
					"text" : "master $1"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 148.0, 43.5, 63.0, 21.0 ],
					"text" : "3. In 3",
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 294.476348876953125, 208.0, 71.0, 27.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 148.0, 59.5, 71.0, 27.0 ],
					"varname" : "p3",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 81.0, 43.5, 63.0, 21.0 ],
					"text" : "2. In 2",
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 252.809677124023438, 171.0, 71.0, 27.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 81.0, 59.5, 71.0, 27.0 ],
					"varname" : "p2",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 268.5, 157.0, 71.0, 27.0 ],
					"varname" : "p8",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 15.0, 59.5, 71.0, 27.0 ],
					"varname" : "p1",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 457.0, 410.0, 124.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 268.5, 186.0, 73.0, 21.0 ],
					"text" : "8/9 Outs"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 15.0, 43.5, 62.0, 21.0 ],
					"text" : "1. In 1",
					"textjustification" : 1
				}
...
, 			{
		...
		"parameters" : 		{
			"obj-8::obj-3" : [ "mixer3_in_2[1]", "IN2", 0 ],
			"obj-8::obj-4" : [ "mixer3_in_3[1]", "IN3", 0 ],
			"obj-8::obj-18" : [ "mixer3_master[1]", "MASTER", 0 ],
			"obj-8::obj-2" : [ "mixer3_in_1[1]", "IN1", 0 ],
			"parameterbanks" : 			{
