...
, 			{
				"box" : 				{
					...
					"hint" : "0.-1.0 floating point data received in this inlet sets the horizontal pattern rotation bound mode (wrap fold clip). off/on messages disable/enable the data inlet.",
					"id" : "obj-62",
					"ignoreclick" : 1,
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 244.656280517578125, 116.50079345703125, 60.0, 15.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 351.000030517578125, 116.50079345703125, 60.0, 15.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_annotation_name" : "Shape",
...
, 			{
				"box" : 				{
					...
					"bordercolor" : [ 1.0, 1.0, 1.0, 1.0 ],
					"focusbordercolor" : [ 1.0, 1.0, 1.0, 1.0 ],
					"hint" : "floating point data received in this inlet sets a multiplier applied to the horizontal pattern used for pattern generation. off/on messages disable/enable the data inlet.",
					"id" : "obj-168",
					"ignoreclick" : 1,
					"maxclass" : "live.toggle",
					"numinlets" : 1,
...
, 			{
				"box" : 				{
					"comment" : "sets a multiplier applied to the horizontal pattern used for pattern generation. 0/1 (integer) turns module off/on.",
					"id" : "obj-171",
					"index" : 12,
					"maxclass" : "inlet",
					"numinlets" : 0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1319.0, 177.5, 96.0, 22.0 ],
					"text" : "scale 0. 1. 0. 11."
				}
...
, 			{
				"box" : 				{
					...
					"bordercolor" : [ 0.1, 0.1, 0.1, 1.0 ],
					"focusbordercolor" : [ 1.0, 0.552941, 0.0, 1.0 ],
					"hint" : "Sets the function to be mapped to the horizontal pattern",
					"hltcolor" : [ 0.556863, 0.556863, 0.556863, 1.0 ],
					"id" : "obj-182",
					"maxclass" : "live.menu",
					"numinlets" : 1,
					...
					"presentation" : 1,
					"presentation_rect" : [ 244.656280517578125, 45.978153228759766, 60.0, 15.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_annotation_name" : "Shape",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1319.0, 409.5, 55.0, 22.0 ],
					"text" : "mode $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_gl_texture", "" ],
					"patching_rect" : [ 1439.5, 733.0, 165.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"activeneedlecolor" : [ 1.0, 1.0, 1.0, 1.0 ],
					"dialcolor" : [ 1.0, 1.0, 1.0, 1.0 ],
					"hint" : "Move this control to set the horizontal pattern rotation in degrees.",
					"id" : "obj-208",
					"maxclass" : "live.dial",
					"needlecolor" : [ 1.0, 1.0, 1.0, 1.0 ],
					"numinlets" : 1,
...
, 			{
				"box" : 				{
					...
					"activeneedlecolor" : [ 1.0, 1.0, 1.0, 1.0 ],
					"dialcolor" : [ 1.0, 1.0, 1.0, 1.0 ],
					"hint" : "Move this control to set the amount of zoom for the horizontal pattern.",
					"id" : "obj-221",
					"maxclass" : "live.dial",
					"needlecolor" : [ 1.0, 1.0, 1.0, 1.0 ],
					"numinlets" : 1,
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 309.0, 45.978153228759766, 40.0, 16.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"bordercolor" : [ 1.0, 1.0, 1.0, 1.0 ],
					"focusbordercolor" : [ 1.0, 1.0, 1.0, 1.0 ],
					"hint" : "0.-1.0 floating point data received in this inlet selects the horizontal pattern used for pattern generation  (0. - 1.0=on, off/on) off/. on messages disable/enable the data inlet.",
					"id" : "obj-233",
					"ignoreclick" : 1,
					"maxclass" : "live.toggle",
					"numinlets" : 1,
...
, 			{
				"box" : 				{
					...
					"bordercolor" : [ 1.0, 1.0, 1.0, 1.0 ],
					"focusbordercolor" : [ 1.0, 1.0, 1.0, 1.0 ],
					"hint" : "0.-1.0 floating point data received in this inlet selects a compositing operation for the horizontal and vertical patterns. off/on messages disable/enable the data inlet.",
					"id" : "obj-51",
					"ignoreclick" : 1,
					"maxclass" : "live.toggle",
					"numinlets" : 1,
...
, 			{
				"box" : 				{
					...
					"fontsize" : 14.0,
					"hint" : "Sets the compositing operation used when combining the horizontal and vertical patterns (Note: some operations may result in one of the patterns being displayed in apparently unmodified form).",
