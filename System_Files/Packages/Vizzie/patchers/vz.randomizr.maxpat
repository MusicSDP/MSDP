...
,
		...
		"digest" : "",
		"tags" : "Vizzie Generator, randomizr",
		"style" : "",
		"subpatcher_template" : "",
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 152.0, 33.0, 70.0, 20.0 ],
					"presentation_rect" : [ 152.0, 33.0, 70.0, 20.0 ],
					"text" : "loadmess 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 400.0, 117.0, 94.0, 20.0 ],
					"presentation_rect" : [ 400.0, 117.0, 94.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 164.0, 729.0, 54.0, 20.0 ],
					"presentation_rect" : [ 164.0, 729.0, 54.0, 20.0 ],
					"text" : "gate 1 1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 164.0, 760.0, 25.0, 25.0 ],
					"presentation_rect" : [ 164.0, 760.0, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 199.0, 499.0, 63.0, 20.0 ],
					"presentation_rect" : [ 199.0, 499.0, 63.0, 20.0 ],
					"text" : "random 100"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 49.0, 39.0, 50.0, 48.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"hint" : "The RANDOMIZR module generates random numbers in the standard Vizzie data range of 0. – 1.0 for use driving other modules and their parameters.",
					"id" : "obj-95",
					"maxclass" : "comment",
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 44.60955810546875, 370.771026611328125, 79.0, 21.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 1.0, 16.0, 79.0, 21.0 ],
					"text" : "RANDOMIZR",
