...
,
		...
		"enablevscroll" : 0,
		"devicewidth" : 0.0,
		"description" : "Generate random control data to control Vizzie modules",
		"digest" : "",
		"tags" : "Vizzie Generator, wandr",
		"style" : "",
		"subpatcher_template" : "",
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 292.0, 17.0, 70.0, 20.0 ],
					"presentation_rect" : [ 292.0, 17.0, 70.0, 20.0 ],
					"text" : "loadmess 1"
				}
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 293.0, 471.0, 32.5, 20.0 ],
					"text" : "* -1"
				}
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 292.0, 149.0, 32.5, 20.0 ],
					"text" : "1"
				}
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 239.0, 149.0, 32.5, 20.0 ],
					"text" : "0"
				}
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 239.0, 117.0, 72.0, 20.0 ],
					"text" : "split 0. 0.49"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 239.0, 62.0, 89.0, 20.0 ],
					"presentation_rect" : [ 239.0, 62.0, 89.0, 20.0 ],
					"text" : "data-handler-L"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 239.0, 23.0, 25.0, 25.0 ],
					"presentation_rect" : [ 239.0, 23.0, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 350.0, 62.0, 15.0, 15.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 584.0, 62.0, 78.0, 20.0 ],
					"presentation_rect" : [ 584.0, 62.0, 78.0, 20.0 ],
					"text" : "data-handler"
				}
...
, 			{
				"box" : 				{
					...
					"bordercolor" : [ 1.0, 1.0, 1.0, 1.0 ],
					"focusbordercolor" : [ 1.0, 1.0, 1.0, 1.0 ],
					"hint" : "An input data value is used to select the step size (0. - 1.0). off/on messages disable/enable the data inlet.",
					"id" : "obj-43",
					"ignoreclick" : 1,
					"maxclass" : "live.toggle",
					"numinlets" : 1,
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 695.0, 62.0, 15.0, 15.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 133.0, 3.0, 9.742591857910156, 9.742591857910156 ],
					"rounded" : 15.0,
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_shortname" : "pictctrl[1]",
...
, 			{
				"box" : 				{
					"comment" : "step size (0. - 1.0). off/on messages disable/enable the data inlet.",
					"id" : "obj-45",
					"index" : 0,
					"maxclass" : "inlet",
					"numinlets" : 0,
					...
					"presentation_rect" : [ 584.0, 23.0, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 584.0, 117.0, 105.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 400.0, 117.0, 88.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 400.0, 62.0, 78.0, 20.0 ],
					"presentation_rect" : [ 400.0, 62.0, 78.0, 20.0 ],
					"text" : "data-handler"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 400.0, 23.0, 25.0, 25.0 ],
					"presentation_rect" : [ 400.0, 23.0, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 511.0, 62.0, 15.0, 15.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 199.0, 595.0, 55.0, 20.0 ],
					"text" : "clip 0. 1."
				}
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 419.0, 149.0, 67.0, 20.0 ],
					"restore" : [ 5.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 199.0, 563.0, 63.0, 20.0 ],
					"text" : "change 0."
				}
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 199.0, 333.0, 65.0, 20.0 ],
					"text" : "qmetro 20"
				}
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 231.5, 384.0, 67.0, 20.0 ],
					"restore" : [ 8.0 ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0
					}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 164.0, 234.0, 46.0, 20.0 ],
					"presentation_rect" : [ 164.0, 234.0, 46.0, 20.0 ],
					"text" : "t i i b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 164.0, 208.0, 108.0, 20.0 ],
					"presentation_rect" : [ 164.0, 208.0, 108.0, 20.0 ],
					"text" : "r ---SyncStart"
				}
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 316.0, 288.0, 38.0, 20.0 ],
					"text" : "set 50"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 347.0, 260.0, 114.0, 20.0 ],
					"presentation_rect" : [ 347.0, 260.0, 114.0, 20.0 ],
					"text" : "r ---SyncReset"
				}
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 164.0, 790.0, 54.0, 20.0 ],
					"text" : "gate 1 1"
				}
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 164.0, 821.0, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 199.0, 499.0, 78.0, 20.0 ],
					"text" : "drunk 100 -2"
				}
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 199.0, 529.0, 99.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"hint" : "This control lets you select data outputs between a wandering \"drunkard's walk\" (left) and random values (right).",
					"id" : "obj-64",
					"maxclass" : "live.dial",
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 301.5, 49.0, 704.0, 49.0 ],
					"order" : 0,
					"source" : [ "obj-125", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 301.5, 49.0, 520.0, 49.0 ],
					"order" : 1,
					"source" : [ "obj-125", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 301.5, 49.0, 359.0, 49.0 ],
					"order" : 2,
					"source" : [ "obj-125", 0 ]
				}
