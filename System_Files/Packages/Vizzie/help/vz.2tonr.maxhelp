...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 10.0, 69.0, 586.0, 21.0 ],
									"text" : "A Vizzie module/abstraction that outputs images as a duotone (2-color image) with colors you select.",
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "int", "", "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 498.0, 607.0, 221.0, 24.0 ]
								}
...
,
									"patching_rect" : [ 498.0, 607.0, 104.0, 23.0 ],
