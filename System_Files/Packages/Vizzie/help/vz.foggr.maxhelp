...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 137.0, 305.0, 229.0, 22.0 ],
					"text" : "window size 20 60 700 700, window exec"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 137.0, 438.0, 182.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 162.0, 341.0, 94.0, 22.0 ],
					"text" : "window getsize"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 137.0, 383.0, 71.0, 22.0 ],
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"outlettype" : [ "int", "", "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 445.0, 572.032776000000013, 221.0, 24.0 ]
								}
...
,
									"patching_rect" : [ 445.0, 572.032776000000013, 104.0, 23.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 242.0, 334.5, 221.0, 79.0 ],
									"text" : "Probability changes the likelihood of a pixel being displaced. The x and y ranges determine the distance that pixels can be moved from their original position.",
...
, 							{
								"box" : 								{
									...
									"offset" : [ 0.0, 0.0 ],
									"outlettype" : [ "" ],
									"patching_rect" : [ 49.0, 470.0, 168.0, 108.0 ],
									"prototypename" : "pixl",
									"varname" : "projectr",
									"viewvisibility" : 1
								}
...
, 							{
								"box" : 								{
									...
									"offset" : [ 0.0, 0.0 ],
									"outlettype" : [ "" ],
									"patching_rect" : [ 49.0, 297.5, 188.0, 130.0 ],
									"prototypename" : "pixl",
									"varname" : "vz.foggr",
									"viewvisibility" : 1
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 14.0, 69.0, 583.0, 21.0 ],
									"text" : "A Vizzie module/abstraction to create fogging or spattering effects for a video or image",
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 14.0, 10.0, 643.0, 60.0 ],
									"text" : "FOGGR / vz.foggr",
									"textcolor" : [ 0.200000002980232, 0.200000002980232, 0.200000002980232, 1.0 ],
