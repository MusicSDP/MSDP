...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"patching_rect" : [ 4.0, 4.0, 198.0, 130.0 ],
					"prototypename" : "pixl",
					"varname" : "pannr",
					"viewvisibility" : 1
				}
		...
		"parameters" : 		{
			...
			"obj-1::obj-53" : [ "pictctrl[3]", "pictctrl[1]", 0 ],
			"obj-1::obj-48" : [ "umenu[6]", "umenu", 0 ],
			"obj-1::obj-37" : [ "y offset", "y offset", 0 ],
			"obj-1::obj-68" : [ "x offset", "x offset", 0 ],
			"obj-1::obj-41" : [ "pictctrl[4]", "pictctrl[1]", 0 ],
			"obj-1::obj-13" : [ "pictctrl[5]", "pictctrl[1]", 0 ]
		}
,
		"dependency_cache" : [ 			{
				"name" : "vz.pannr.maxpat",
