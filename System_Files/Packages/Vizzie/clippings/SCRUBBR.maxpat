...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 2.0, 2.0, 148.0, 198.0 ],
					"prototypename" : "pixl",
					"varname" : "scrubbr",
					"viewvisibility" : 1
				}
		...
		"lines" : [  ],
		"parameters" : 		{
			"obj-1::obj-1" : [ "range[3]", "range", 0 ],
			"obj-1::obj-51" : [ "pictctrl[5]", "pictctrl[1]", 0 ],
			"obj-1::obj-15" : [ "pictctrl[6]", "pictctrl[1]", 0 ],
			"obj-1::obj-17" : [ "pictslider", "pictslider", 0 ],
			"obj-1::obj-18" : [ "pictctrl[2]", "pictctrl[1]", 0 ],
			"obj-1::obj-12" : [ "pictctrl[1]", "pictctrl[1]", 0 ]
		}
,
		"dependency_cache" : [ 			{
				"name" : "vz.scrubbr.maxpat",
