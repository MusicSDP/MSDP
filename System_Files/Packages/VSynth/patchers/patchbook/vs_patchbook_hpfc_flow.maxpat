...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 586.0, 231.5, 207.0, 22.0 ],
					"style" : "",
					"text" : "read vs_patchbook_hpfc_flow.json, 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 586.0, 199.5, 60.0, 22.0 ],
					"style" : "",
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 28.0, 617.0, 200.0, 61.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 443.0, 243.5, 79.0, 22.0 ],
					"style" : "",
					"text" : "clientwindow"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 357.5, 276.0, 171.5, 60.0 ],
					"pattrstorage" : "hpfc_flow_osc",
					"presentation" : 1,
					"presentation_rect" : [ 777.0, 784.0, 100.0, 40.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 400.0, 243.5, 36.0, 22.0 ],
					"style" : "",
					"text" : "write"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 357.5, 243.5, 35.0, 22.0 ],
					"style" : "",
					"text" : "read"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 361.0, 287.0, 154.0, 22.0 ],
					"priority" : 					{
...
,
					"saved_object_attributes" : 					{
						"client_rect" : [ 4, 45, 613, 671 ],
						"parameter_enable" : 0,
						"storage_rect" : [ 583, 69, 1034, 197 ]
					}
,
					"style" : "",
					"text" : "pattrstorage hpfc_flow_osc",
					"varname" : "hpfc_flow_osc"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 123.0, 13.0, 304.0, 89.0 ],
					"varname" : "vs_wfg_2[1]",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 144.0, 489.0, 174.0, 38.0 ],
					"varname" : "vs_fader[2]",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture", "jit_gl_texture" ],
					"patching_rect" : [ 28.0, 118.0, 304.0, 89.0 ],
					"varname" : "vs_wfg_2",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 28.0, 687.0, 112.0, 16.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture" ],
					"patching_rect" : [ 28.0, 562.5, 64.0, 32.0 ],
					"varname" : "vs_op2",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture" ],
					"patching_rect" : [ 28.0, 352.0, 174.0, 38.0 ],
					"varname" : "vs_fader",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 373.0, 415.0, 200.0, 61.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture" ],
					"patching_rect" : [ 307.0, 415.0, 50.0, 60.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture" ],
					"patching_rect" : [ 243.0, 415.0, 50.0, 60.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture", "jit_gl_texture" ],
					"patching_rect" : [ 144.0, 415.0, 84.0, 62.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture" ],
					"patching_rect" : [ 28.0, 221.0, 128.0, 115.0 ],
					"varname" : "vs_preview",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture" ],
					"patching_rect" : [ 28.0, 415.0, 91.0, 108.0 ],
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 37.5, 604.0, 581.0, 604.0, 581.0, 391.0, 382.5, 391.0 ],
					"order" : 0,
					"source" : [ "obj-6", 0 ]
				}
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-17::obj-12" : [ "wfg2_sync_dir", "sync_invert", 0 ],
