...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 598.5, 311.0, 63.0, 22.0 ],
					"style" : "",
					"text" : "enable $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 557.5, 271.0, 101.0, 22.0 ],
					"style" : "",
					"text" : "route amt enable"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 557.5, 220.0, 30.0, 30.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 357.0, 246.0, 96.0, 22.0 ],
					"restore" : 					{
						"fdbck_amount" : [ 0.0 ]
					}
,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 294.0, 301.0, 37.0, 22.0 ],
					"style" : "",
					"text" : "r dim"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 432.0, 134.0, 60.0, 22.0 ],
					"style" : "",
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 432.0, 168.877106, 60.0, 22.0 ],
					"style" : "",
					"text" : "s trig_res"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 169.0, 480.0, 30.0, 30.0 ],
					"style" : ""
				}
...
,
					"patching_rect" : [ 294.0, 373.0, 144.0, 22.0 ],
					"style" : "",
...
,
					"patching_rect" : [ 169.0, 410.0, 144.0, 22.0 ],
					"style" : "",
					"text" : "jit.gl.pix vsynth @adapt 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 205.0, 175.0, 72.0, 22.0 ],
					"style" : "",
					"text" : "r slide_time"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 177.0, 220.0, 47.0, 22.0 ],
					"style" : "",
					"text" : "pak f 6"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 177.0, 261.0, 49.0, 22.0 ],
					"style" : "",
					"text" : "bline 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 271.0, 212.0, 44.0, 22.0 ],
					"style" : "",
					"text" : "r draw"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 72.0, 63.0, 56.0, 15.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 144.0, 155.75, 44.0, 35.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 1.0, 15.0, 44.0, 35.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 144.0, 301.0, 47.0, 22.0 ],
					"style" : "",
					"text" : "amt $1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 55.0, 93.0, 128.0, 128.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 0.0, 15.0, 45.0, 35.0 ],
					"rounded" : 0,
					"style" : ""
				}
